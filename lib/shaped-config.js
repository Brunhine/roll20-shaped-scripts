...
module.exports = class ShapedConfig {
  ...
  static percentValidator(value) {
    let parsed = parseFloat(value);
    parsed = parsed > 1 ? parsed / 100 : parsed;
    return {
      converted: parsed.toFixed(2),
      valid: parsed <= 1 && parsed >= 0,
    };
  }
  ...
  static get configOptionsSpec() {
    return {
      ...
      sheetEnhancements: {
        ...
        ammoManager: {
          enabled: this.booleanValidator,
          useTurnCounter: this.booleanValidator,
          recoveryPercent: this.percentValidator,
          autoRecover: this.booleanValidator,
        },
      },
      genderPronouns: [
        {
